...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("8 ft. SM-Rib Galvalume Steel Roof/Siding Panel", "metal_corrugated_panel"),
        ("26 in. x 8 ft. Galvanized Steel 5V Crimp Roof Panel", "metal_corrugated_panel"),
        ("144 in. Galvanized Metal Roof Panel", "metal_corrugated_panel"),
